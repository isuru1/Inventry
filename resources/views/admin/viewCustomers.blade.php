            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <script>
                                            ...
                                            function delete_customers(){
                                              ...
                                              var id =$("#DelID").val();
                                              $.post( "customers/delete", { delId: id , "_token": "{{ csrf_token() }}"})
                                              .done(function( data ) {
                                          ...
                                          <div class="modal modal-danger" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <a href="" class="btn btn-outline" onclick="delete_customers()"><i></i>Delete</a> </div>
                                                </div>
                                                <!-- /.modal-content -->
                                              </div>
                                              <!-- /.modal-dialog -->
                                            ...
                                            <!-- /.modal -->
                                            <tbody>
                                             @foreach ($CustomersList as $CustomersDetail)
                                             <tr>                                               
                                               <td>{{ $CustomersDetail->customer_name }}</td>
                                               <td>{{ $CustomersDetail->email }}</td>                 
                                               <td>{{ $CustomersDetail->mobile }}</td>
                                               <td>
                                                @if($CustomersDetail->status == 1)
                                              ...
                                              <td>
                                                <div class="btn-xs btn-group">
                                                  ...
                                                  <ul class="dropdown-menu" role="menu">
                                                    <li><a href="{{ URL('customers/'.$CustomersDetail->id.'/edit')}}">Edit</a></li>
                                                    <li><a href="#" onclick="set_del({{ $CustomersDetail->id }})" data-toggle="modal" data-target="#myModal">Delete</a></li>                    
